...
[Evidence and remaining work](CLASSIC_RUN_PERSISTENCE.md).

**Preceding published checkpoint:** Table setup has localized cumulative difficulty rules,
...
TypeScript, targeted lint and the production/PWA build passed. Deployed as
**v1.0.260923-5** after independent CI passed all tests/build. The public manifest
and tag match; hosted desktop/touch Full Unlock and gameplay smoke checks passed.
...
user choice; no historic totals/unlocks are revoked. Deployed as **v1.0.260923-4**
with independent CI, manifest/tag/art hash and hosted desktop/touch verification.
[Evidence](CHARTER_PROGRESSION_IMPLEMENTATION.md#spending-classification-and-plentiful-stock).

**Preceding published follow-up:** All sixteen upgraded Charters now require an earned
...
TypeScript, targeted lint and the production/PWA build passed. Deployed as
**v1.0.260923-3**, with independent CI and hosted desktop/touch verification.
[Eligibility evidence](CHARTER_PROGRESSION_IMPLEMENTATION.md#achievement-gated-offers-and-purchases).

**Preceding published follow-up:** Omen Lens/Observatory now count successfully used
...
and the production/PWA build passed. Deployed as **v1.0.260923-2** with independent
CI and hosted desktop/touch verification;
[scope and evidence](CHARTER_PROGRESSION_IMPLEMENTATION.md#pack-use-provenance-follow-up).
