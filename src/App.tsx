...
export function GameplayScreen() {
  ...
  return (
    <SeigaihaBackground showFrame={true} frameInset={12} showVignette={true}>
      <div className="viewport-full flex flex-col">
        {/* Top bar */}
        <div className="flex items-center justify-between px-4 py-2 bg-[var(--color-dark-forest)]/90 text-[var(--color-beige-white)]">
        ...
        <div className="flex gap-2 px-4 py-2 overflow-x-auto">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="flex-shrink-0 w-16 h-20 bg-[var(--color-dark-forest)]/80 rounded-lg border-2 border-[var(--color-metallic-gold)] flex items-center justify-center text-2xl"
            >
              📜
            </div>
          ))}
          <div className="flex-shrink-0 w-16 h-20 bg-[var(--color-dark-forest)]/60 rounded-lg border-2 border-dashed border-[var(--color-metallic-gold)] flex items-center justify-center text-2xl opacity-50">
            +
          </div>
        </div>

        {/* Round target */}
        <div className="flex-shrink-0 mx-4 my-4 p-4 bg-[var(--color-dark-forest)]/80 rounded-lg text-center backdrop-blur-sm">
        ...
        {/* Play area */}
        <div className="flex-1 mx-4 mb-2 bg-[var(--color-dark-forest)]/50 rounded-lg border-2 border-dashed border-[var(--color-metallic-gold)] flex items-center justify-center backdrop-blur-sm">
        ...
        {/* Shanten status */}
        <div className="mx-4 mb-2 px-4 py-2 bg-[var(--color-dark-forest)]/80 rounded-lg text-center backdrop-blur-sm">
        ...
        <div className="mx-4 mb-2 p-4 bg-[var(--color-dark-forest)]/80 rounded-lg backdrop-blur-sm">
          <HandWithDiscardZone
            tiles={handTiles}
            size={tileSize}
        ...
        {/* Action buttons */}
        <div className="flex justify-center gap-4 px-4 py-4 bg-[var(--color-dark-forest)]/90">
